...
window.NOTES = [
  ...
  },
  {
    ...
    summary: {
      zh: "滚动记录 GitHub 当天/一周/一月/半年/一年的 Top stars 仓库(图文 + 动图),并分析技术方向与趋势(历史/当下/未来,带证据)。历史全部保留。",
      en: "A rolling log of GitHub's top-starred repos across day/week/month/half-year/year (illustrated + animated), with direction & trend analysis (history/present/future, with evidence). History preserved.",
    },
    date: "2026-06-22",
    tags: ["GitHub", "Trending", "Agent Skills", "Context Engineering", "Trend Analysis"],
  },
  {
