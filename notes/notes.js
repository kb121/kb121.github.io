...
window.NOTES = [
  ...
  },
  {
    ...
    summary: {
      zh: "滚动记录 GitHub 当天/一周/一月/半年/一年多窗口热门仓库(图文卡片 + 多动图),分析当日前十的技术方向与趋势(历史/当下/未来,带证据)。2026-07-09 主线:agent 长出感官与手(感知-执行闭环)。历史全部保留。",
      en: "A rolling log of GitHub hot repos across day/week/month/6mo/year windows (illustrated cards + animated charts), analyzing the daily top 10's directions and trend (history/present/future, with evidence). 2026-07-09 theme: agents grow senses and hands (a sensorimotor loop). History preserved.",
    },
    date: "2026-07-09",
    tags: ["GitHub", "Trending", "Multi-window", "Agent Senses", "Actuation", "Trend Analysis"],
  },
  {
