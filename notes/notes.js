...
window.NOTES = [
  ...
  },
  {
    ...
    title: {
      zh: "GitHub Top Stars 与技术趋势(多窗口)",
      en: "GitHub Top Stars & Tech Trends (Multi-window)",
    },
    summary: {
      zh: "滚动记录 GitHub 当天/一周/一月/半年/一年各 Top 5 新星,图文介绍,并对一年窗口前 10 做方向归类与趋势分析(历史/当下/未来,带证据,多动图)。历史全部保留。",
      en: "A rolling log of GitHub's top-5 new stars across day/week/month/half-year/year, illustrated, plus a Top-10 direction & trend analysis on the year window (history/present/future, animated). History preserved.",
    },
    date: "2026-06-25",
