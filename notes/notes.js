...
window.NOTES = [
  {
    ...
    summary: {
      zh: "2026-06-30 快照(2026-07-03 复核):全球前十大模型按综合对话、综合知识、代码能力三类分别排名并标注来源(LMArena / Artificial Analysis / SWE-bench / LiveCodeBench),新增一张「十年 Top-10 名次爬升图(bump chart)」动图回顾十年演进。",
      en: "2026-06-30 snapshot (re-checked 2026-07-03): the world's top LLMs ranked across overall conversation, knowledge, and code — each with cited sources (LMArena / Artificial Analysis / SWE-bench / LiveCodeBench) — with a new ten-year Top-10 rank-change bump chart plus animated charts reviewing a decade.",
    },
    date: "2026-07-03",
