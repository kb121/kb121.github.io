...
window.NOTES = [
  ...
  },
  {
    ...
    summary: {
      zh: "2026-06-30 基线、2026-07-12 复核:全球前十大模型按综合对话、综合知识、代码能力三类分别排名并标注来源(LMArena / Artificial Analysis / SWE-bench / LiveCodeBench);GPT-5.6 Sol 登场后重排智力榜,并用多组动图(含十年排名接力曲线)回顾十年演进。",
      en: "2026-06-30 baseline, re-checked 2026-07-12: the world's top LLMs ranked across overall conversation, knowledge, and code — each with cited sources (LMArena / Artificial Analysis / SWE-bench / LiveCodeBench); board rebuilt after GPT-5.6 Sol landed, plus animated charts (incl. a ten-year rank-relay bump chart) reviewing a decade of evolution.",
    },
    date: "2026-07-12",
  ...
  },
  {
    ...
    date: "2026-07-12",
    tags: ["GitHub", "Trending", "Multi-window", "Skill Supply Chain", "Trend Analysis"],
  },
  {
