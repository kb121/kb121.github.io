...
window.NOTES = [
  ...
  },
  {
    ...
    summary: {
      zh: "全球前十大模型按综合对话、综合知识、代码能力三类分别排名并标注来源(LMArena / Artificial Analysis / SWE-bench / LiveCodeBench),并用多组动图(含十年名次曲线)回顾演进。2026-07-11 复核:GPT-5.6 Sol 登智力榜第 2、易主「可用最强」。",
      en: "The world's top LLMs ranked across overall conversation, knowledge, and code — each with cited sources (LMArena / Artificial Analysis / SWE-bench / LiveCodeBench) — plus animated charts (incl. a 10-year rank curve). Re-checked 2026-07-11: GPT-5.6 Sol reaches #2 on intelligence, taking “strongest usable.”",
    },
    date: "2026-07-11",
  ...
  },
  {
    ...
    date: "2026-07-11",
    tags: ["GitHub", "Trending", "Multi-window", "Agent Skills", "Trend Analysis"],
  },
  {
