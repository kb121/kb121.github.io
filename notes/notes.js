...
window.NOTES = [
  {
    ...
    summary: {
      zh: "滚动更新的商用加速卡榜:NVIDIA / AMD / 昇腾 / TPU / Trainium / Maia / MTIA / 阿里平头哥真武 / Tesla / SambaNova / d-Matrix / Etched / FuriosaAI / Rebellions / Qualcomm / Cerebras / Tenstorrent / Intel / 昆仑芯 / 寒武纪 / 摩尔线程 / 沐曦 / 海光 / 壁仞 / 燧原 / 天数智芯 / 东方算芯 共 27 家厂商最新各 3 款卡,按显存、算力、算力带宽比(roofline 山脊点)、数值格式原生支持、Scale-up 超节点域、片上 SRAM/L2、TDP 与液冷、软件栈成熟度与实测 MFU 十维加权排名,H20 = 100 基线,含 20 张动图与全部来源链接。2026-07-29 复核:WAIC 2026 的整柜超节点数据把摩尔线程 / 沐曦 / 燧原的 scale-up 域从 8 卡改写为 64–256 卡并重算指数(第一次改分),AMD×Cerebras 让 PD 分离跨过厂商边界,Kimi K3 开源 48 小时的 Day-0 竞赛给「第三层」软件栈第一把横向尺子,另新增不用 HBM 的东方算芯 DF1000。",
      en: "A rolling board of the latest three accelerators from each of 27 vendors (NVIDIA, AMD, Ascend, TPU, Trainium, Microsoft Maia, Meta MTIA, Alibaba T-Head Zhenwu, Tesla, SambaNova, d-Matrix, Etched, FuriosaAI, Rebellions, Qualcomm, Cerebras, Tenstorrent, Intel, Kunlunxin, Cambricon, Moore Threads, MetaX, Hygon, Biren, Enflame, Iluvatar, DFSX), ranked on ten weighted dimensions — memory, compute, FLOP/byte ridge point, native numeric formats, scale-up superpod domain, on-chip SRAM/L2, TDP and liquid cooling, plus software-stack maturity and measured MFU — normalized to H20 = 100, with a section on non-HBM routes (SRAM, 3D near-memory DRAM, LPDDR, wafer-scale), 20 animated figures, and every source linked. Re-checked 2026-07-29: rack-scale superpod data from WAIC 2026 rewrites the scale-up domain of three Chinese cards from 8 to 64–256 and re-scores them, AMD x Cerebras pushes prefill/decode disaggregation across vendor boundaries, and the 48-hour Kimi K3 day-0 race finally gives the software-stack layer a comparable yardstick.",
    },
    date: "2026-07-29",
