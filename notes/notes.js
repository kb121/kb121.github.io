...
window.NOTES = [
  {
    ...
    summary: {
      zh: "每日滚动记录 GitHub 当日新增 stars 前十仓库,一句话介绍,并用多张动图分析技术方向与趋势(历史/当下/未来,带证据)。历史全部保留。",
      en: "A daily-rolling log of the top 10 repos by stars gained that day, with one-line intros and an animated, evidence-backed trend analysis (history/present/future). History preserved.",
    },
    date: "2026-06-09",
    tags: ["GitHub", "Trending", "AI Agents", "Trend Analysis", "Visualized"],
  },
  {
